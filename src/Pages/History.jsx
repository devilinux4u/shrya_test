...
const History = () => {
  ...
  useEffect(() => {
    const fetchActivities = async () => {
      try {
        setIsLoading(true);
        const response = await fetch("https://api.example.com/activities"); // Replace with actual API endpoint
        if (!response.ok) {
      ...
      result = result.filter(
        (activity) =>
          ...
          (activity.details &&
            ...
            activity.details.itemName.toLowerCase().includes(query))
      );
    }
      ...
      {selectedActivity && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-xl p-6 w-full max-w-md max-h-[90vh] overflow-y-auto">
            ...
            <div className="flex items-center mb-4">
              <div
                className={`w-8 h-8 rounded-full flex items-center justify-center mr-3 ${
                  getActivityColor(selectedActivity.type).split(" ")[0]
                }`}
              >
              ...
              <span
                className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${
                  getStatusBadge(selectedActivity.status).bgColor
                } ${getStatusBadge(selectedActivity.status).textColor}`}
              >
            ...
            {selectedActivity.details.vehicleImage ||
            selectedActivity.details.itemImage ? (
              <div className="mb-4 rounded-lg overflow-hidden">
                <img
                  ...
                  alt={
                    selectedActivity.details.vehicleName ||
                    selectedActivity.details.itemName
                  }
            ...
            <div className="space-y-4 mb-6">
              ...
              {selectedActivity.type === "rental" && (
                <>
                  <div className="flex justify-between">
                    ...
                    <span className="text-sm font-medium">
                      {selectedActivity.details.bookingId}
                    </span>
                  </div>
                  <div className="flex justify-between">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="text-sm font-medium">
                      {formatDate(selectedActivity.details.startDate)} -{" "}
                      {formatDate(selectedActivity.details.endDate)}
                    </span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-sm text-gray-500">Price</span>
                    <span className="text-sm font-medium">
                      Rs. {selectedActivity.details.price.toLocaleString()}
                    </span>
                  </div>
                  <div className="flex justify-between">
              ...
              {(selectedActivity.type === "lost" ||
                selectedActivity.type === "found") && (
                <>
                  <div className="flex justify-between">
              ...
              {selectedActivity.type === "wishlist" && (
                <>
                  <div className="flex justify-between">
                    ...
                    <span className="text-sm font-medium">
                      {selectedActivity.details.itemId}
                    </span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-sm text-gray-500">Item</span>
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="text-sm font-medium">
                      {selectedActivity.details.transactionId ||
                        selectedActivity.details.inquiryId}
                    </span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-sm text-gray-500">Vehicle</span>
